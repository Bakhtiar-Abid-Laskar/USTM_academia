      ...
      <main className="flex-1">
        ...
        <section className="bg-primary text-white">
          <div className="max-w-content mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center">
            ...
            <Link
              href="/search"
              className="inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg px-5 py-3 text-sm text-primary-100 transition-colors max-w-lg w-full justify-center sm:justify-start"
            >
